...
*		the progress_report_individual the function drops the data into three date buckets based on the parameters below. Each bucket is delimited
*		by a number 1, 2, and 3 for each date range.
...
*
* @note:        to drop/delete the function - DROP FUNCTION progress_report_individual_multidate(integer, date, date, date, date, date, date, integer, boolean);
*
* @test		mes_incomplete_three_to_ten.sql studentId=101
* 		"2002-05-24 00:00:00" "2002-07-30 00:00:00" - Records 	1-735
*		"2002-07-31 00:00:00" "2002-10-31 00:00:00" - Records  	736-1384 
*		"2002-11-01 00:00:00" "2003-10-28 00:00:00" - Records  	1385-2050
*
* @verify	SELECT * FROM "tblTaskEvaluations"
*		WHERE "tblTaskEvaluations"."studentId" = 101
*		AND "tblTaskEvaluations"."evaluationDate" between '2002-05-24' and '2002-07-30'
*		ORDER BY "tblTaskEvaluations"."evaluationDate"		
*
*/

CREATE OR REPLACE FUNCTION progress_report_individual_multidate(studentId INTEGER,evaluationDateFromOne DATE, evaluationDateToOne DATE , evaluationDateFromTwo DATE , evaluationDateToTwo DATE , evaluationDateFromThree DATE , evaluationDateToThree DATE , subjectId INTEGER DEFAULT 0, latest BOOLEAN DEFAULT FALSE) 
